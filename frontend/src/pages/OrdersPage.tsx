                ...
                <div style={{ padding: '1.25rem' }}>
                  {order.items.map((item, idx) => (
                    <div key={item.id} style={{
                      ...
                      <div style={{ width: '80px', height: '80px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
